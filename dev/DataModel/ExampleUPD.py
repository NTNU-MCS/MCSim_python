...
def save_individual_tags(raw_msg, target_list, verbose = False):
    #Tiny  
    tag = 'unknown'
...
def parse_nmea_message(raw_msg, loop_limit = 1, __loop_count = 0):    
    try:  
        ...
        save_individual_tags(raw_msg, parsed_msg_tags, tag_verbose)
        ...
        try:  
            ...
            try:
                ...
                try: 
                    save_individual_tags(raw_msg, unknown_msg_tags, tag_verbose)
