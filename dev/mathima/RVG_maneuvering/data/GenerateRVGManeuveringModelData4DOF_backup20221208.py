...
GMT = 1.1 #ranges from 1.608 to 1.8895 depending on loading condition
...
Ma[0,0] = Ma_lf[0,0]*1 #surge
Ma[1,1] = Ma_lf[1,1]*1.5 #sway-yaw subsystem
#Ma[1,5] = Ma_lf[1,5] #sway-yaw subsystem
#Ma[5,1] = Ma_lf[5,1] # Ma_lf[5,1] #sway-yaw subsystem

Ma[1,5] = (Ma_lf[1,5]+Ma_lf[5,1])*0.5*2 #sway-yaw subsystem
Ma[5,1] = Ma[1,5] # Ma_lf[5,1] #sway-yaw subsystem

Ma[5,5] = Ma_lf[5,5]*2 #sway-yaw subsystem
