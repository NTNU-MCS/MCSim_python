...
# =============================================================================
    ...
    plt.title('Surge course keeping')
    ...
    plt.xlabel('Time [s]')
    plt.ylabel('Roll angle [deg/s]')
    plt.title('Azimuth angle course keeping')
    plt.legend(('Revs=150RPM','Revs=200RPM','Revs=250RPM'))
    ...
    plt.xlabel('x [m]')
    plt.ylabel('y [m]')
    plt.title('Trajectory course keeping')
    plt.legend(('Revs=150RPM','Revs=200RPM','Revs=250RPM'))
